...
def solve_greedy(
    ...
    Returns:
        Dict with keys:
          ...
          - env_reward (float): step_penalty * num_steps + success_reward if success
                                + cumulative term-similarity shaping (PBRS-style).
    """
