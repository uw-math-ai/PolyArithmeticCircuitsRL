...
class Game:
    def __init__(self, sympy_poly, vec_poly, config, index_to_monomial, monomial_to_index):
        ...
        for i in range(config.n_variables):
            self.poly_vectors.append(create_polynomial_vector(index_to_monomial, monomial_to_index, n, d, var_idx=i))
        self.poly_vectors.append(create_polynomial_vector(index_to_monomial, monomial_to_index, n, d, constant_val=1))

        # Initial L1 norm distance
