...
class CandidateFeatureEncoder:
    ...
    def encode(
        ...
        values: dict[str, float] = {
            ...
            "candidate_tier1_score": float(candidate.tier1_score),
            "candidate_tier2_score": float(candidate.tier2_score),
            "candidate_heuristic_score": float(candidate.heuristic_score),
...
FEATURE_NAMES = (
    ...
    *(f"feature_{name}" for name in CANDIDATE_FEATURE_NAMES),
    "candidate_tier1_score",
    "candidate_tier2_score",
